...
INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Apertura tienda','Cecilio Campos','2018-07-19-','La apertura de la 
...
El pueblo de Villadiego está muy contento con la llegada de semejante cocinero. Los precios nuevos son los siguientes:
    ...
    Oreo -> De 4.99€ a Demanda del McDonalds','img/eventos/evento1/portada-evento1.png','img/eventos/evento1/imagen-evento1-1.png','img/eventos/evento1/imagen-evento1-2.png',1
);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Firma de autografos','Cecilio Campos','2020-03-24','Tras la gran acogida que
...
'img/eventos/evento2/portada-evento2.png','img/eventos/evento2/imagen-evento2-1.png','img/eventos/evento2/imagen-evento2-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Magia con Helados','Alberto Campos','2017-04-09','El hermano de Cecilio,
...
adultos','img/eventos/evento3/portada-evento3.png','img/eventos/evento3/imagen-evento3-1.png','img/eventos/evento3/imagen-evento3-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Vista a la Playa','Cecilia Campos','2019-11-10','La hermana
...
mejor!', 'img/eventos/evento4/portada-evento4.png','img/eventos/evento4/imagen-evento4-1.png','img/eventos/evento4/imagen-evento4-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Exposición de cuadros','Marta Lagos','2016-05-20','La madre de
...
café.','img/eventos/evento5/portada-evento5.png','img/eventos/evento5/imagen-evento5-1.png','img/eventos/evento5/imagen-evento5-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Rodaje del anuncio','Jose Hernández','2018-10-27','José Hernández,
...
,'img/eventos/evento6/portada-evento6.png','img/eventos/evento6/imagen-evento6-1.png','img/eventos/evento6/imagen-evento6-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Rodaje película','Jose Hernández','2020-04-01','Tras el lanzamiento del anuncio
...
,'img/eventos/evento7/portada-evento7.png','img/eventos/evento7/imagen-evento7-1.png','img/eventos/evento7/imagen-evento7-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('Crisis: Denuncia de una madre que afirma que tiene mucho azucar',
...
no un juez del Tribunal Supremo.','img/eventos/evento8/portada-evento8.png','img/eventos/evento8/imagen-evento8-1.png','img/eventos/evento8/imagen-evento8-2.png',1);

INSERT INTO eventos (titulo, autor, fecha, descripcion, portada, imagen1, imagen2,publicado) VALUES ('50 Cosas sobre Cecilio: De ex-militar a cocinero profesional',
...
,'img/eventos/evento9/portada-evento9.png','img/eventos/evento9/imagen-evento9-1.png','img/eventos/evento9/imagen-evento9-2.png',1);
